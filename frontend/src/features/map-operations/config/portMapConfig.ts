...
export const METER_COORDINATES_ADAPTER: Record<string, MeterCoordinateAdapter> = {
  'CT-001': {
    ...
    coordinates: { x: 0.4923, y: 0.8115 },
    anchorDirection: 'top',
  },
  'CT-002': {
    meterCode: 'CT-002',
    zoneId: 'zone-warehouse',
    coordinates: { x: 0.1708, y: 0.4596 },
    anchorDirection: 'right',
  },
  'CT-003': {
    meterCode: 'CT-003',
    zoneId: 'zone-berth',
    coordinates: { x: 0.2269, y: 0.2769 },
    anchorDirection: 'left',
  },
  'CT-004': {
    meterCode: 'CT-004',
    zoneId: 'zone-berth',
    coordinates: { x: 0.4692, y: 0.2769 },
    anchorDirection: 'left',
  },
  'CT-005': {
    meterCode: 'CT-005',
    zoneId: 'zone-warehouse',
    coordinates: { x: 0.3062, y: 0.4596 },
    anchorDirection: 'right',
  },
  'CT-006': {
    meterCode: 'CT-006',
    zoneId: 'zone-warehouse',
    coordinates: { x: 0.1708, y: 0.5769 },
    anchorDirection: 'right',
  },
  'CT-007': {
    meterCode: 'CT-007',
    zoneId: 'zone-technical',
    coordinates: { x: 0.2038, y: 0.8154 },
    anchorDirection: 'top',
  },
  'CT-008': {
    meterCode: 'CT-008',
    zoneId: 'zone-berth',
    coordinates: { x: 0.7154, y: 0.2769 },
    anchorDirection: 'left',
  },
  'CT-009': {
    meterCode: 'CT-009',
    zoneId: 'zone-technical',
    coordinates: { x: 0.6192, y: 0.8115 },
    anchorDirection: 'bottom',
  },
  'CT-010': {
    meterCode: 'CT-010',
    zoneId: 'zone-technical',
    coordinates: { x: 0.6654, y: 0.8115 },
    anchorDirection: 'bottom',
  },
  'CT-011': {
    meterCode: 'CT-011',
    zoneId: 'zone-container',
    coordinates: { x: 0.5292, y: 0.5000 },
    anchorDirection: 'top',
  },
  'CT-012': {
    meterCode: 'CT-012',
    zoneId: 'zone-container',
    coordinates: { x: 0.7015, y: 0.5000 },
    anchorDirection: 'top',
  },
};
