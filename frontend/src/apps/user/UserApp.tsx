...
export default function UserApp() {
  ...
  // 2.5 Admin Guard on User Portal (Strict Policy: Never mount Admin workspace here)
  if (currentUser.role === 'ADMIN') {
    return (
      <div className="app-container" style={{ justifyContent: 'center', alignItems: 'center', padding: '24px', textAlign: 'center', minHeight: '100vh', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '440px', background: '#ffffff', borderRadius: '16px', padding: '32px 24px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', border: '1px solid #E2E8F0' }}>
          <div style={{ width: '56px', height: '56px', borderRadius: '50%', background: '#EFF6FF', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px auto', color: '#1D4ED8' }}>
  ...
  // 6. Authenticated User Work Schedule & Leave View
